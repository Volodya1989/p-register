...
`},8122:(e,t,i)=>{i.d(t,{A:()=>n});var o=i(5508);const r=i(1529).Ay.div`
  ...
  margin-top: 15%;
`;var a=i(579);const n=()=>(0,a.jsx)(r,{children:(0,a.jsx)(o.IN,{strokeColor:"#f4c550",margin:"auto",textAlign:"center",strokeWidth:"5",animationDuration:"0.75",width:"96",visible:!0})})},6751:(e,t,i)=>{i.d(t,{As:()=>g,D0:()=>d,DZ:()=>n,JU:()=>p,Kw:()=>x,O6:()=>c,PG:()=>u,VY:()=>a,_W:()=>m,mO:()=>l,pW:()=>s});var o=i(1529),r=i(3401);o.Ay.img`
  positon: relative;
`;const a=o.Ay.div`
  position: relative;
  display: block;

...
`},8122:(e,t,r)=>{r.d(t,{A:()=>o});var a=r(5508);const i=r(1529).Ay.div`
  ...
  margin-top: 15%;
`;var s=r(579);const o=()=>(0,s.jsx)(i,{children:(0,s.jsx)(a.IN,{strokeColor:"#f4c550",margin:"auto",textAlign:"center",strokeWidth:"5",animationDuration:"0.75",width:"96",visible:!0})})},6751:(e,t,r)=>{r.d(t,{As:()=>m,D0:()=>p,DZ:()=>o,JU:()=>l,Kw:()=>c,O6:()=>u,PG:()=>x,VY:()=>s,_W:()=>g,mO:()=>d,pW:()=>n});var a=r(1529),i=r(3401);a.Ay.img`
  positon: relative;
`;const s=a.Ay.div`
  position: relative;
  display: block;
